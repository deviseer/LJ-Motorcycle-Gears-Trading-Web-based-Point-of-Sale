  <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
      <div class="container-fluid">
        ...
        <!-- Offcanvas Triggrer -->
        <a class="navbar-brand fw-bold me-auto" href="">LJ MOTORGEAR TRADING</a>
          ...
          <nav class="navbar-dark">
            <ul class="navbar-nav">
              <img src="assets/images/Avatar.png" alt="" width="100" height="100" class="rounded mx-auto d-block mt-3">
                <h6 class="text-center fw-bold mt-2 text-dark"> </h6>
              ...
              <li>
                <hr class="dropdown-divider mt-2">
                    ...
                    <div class="list-group" id="list-tab" role="tablist">
                      <a class="list-group-item list-group-item-action active bg-dark text-white" id="list-home-list" data-bs-toggle="list" onclick="window.location.href='admin_page.php'" role="tab" aria-controls="list-home">
                      ...
                      <a class="list-group-item list-group-item-action bg-dark text-white" id="list-settings-list" data-bs-toggle="list" onclick="window.location.href='user/user.php'" role="tab" aria-controls="list-settings">
