<div class="modal fade" id="modal-cashier" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      ...
      <div class="modal-header">
			...
			<div class="modal-body">
				<div>
					...
					<input type="hidden" name="position" value="cashier"/></div>
				</div>
