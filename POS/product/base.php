              ...
              <li>
                <hr class="dropdown-divider mt-2">
                    ...
                    <div class="list-group" id="list-tab" role="tablist">
                      ...
                      <a class="list-group-item list-group-item-action bg-dark text-white active" id="list-settings-list" data-bs-toggle="list" onclick="window.location.href=''" role="tab" aria-controls="list-settings">
